...
import org.thingml.generated.api.IMessageSerializer_RemoteControl;
import org.thingml.generated.api.IMessageSerializer_outClient;
...
public class MessageSerializer extends Component
		implements
			IMessageSerializer_RemoteControl {

	private List<IMessageSerializer_outClient> out_clients = new LinkedList<IMessageSerializer_outClient>();
	public void registerOnOut(IMessageSerializer_outClient client) {
		out_clients.add(client);
	}

	public void unregisterFromOut(IMessageSerializer_outClient client) {
		out_clients.remove(client);
	}

	@Override
	public void changeDisplay_via_RemoteControl() {
		receive(changeDisplayType.instantiate(RemoteControl_port),
				RemoteControl_port);
	}
	...
	private void sendWrite_bytes_via_out(
		...
		for (IMessageSerializer_outClient client : out_clients) {
	...
	public MessageSerializer(final byte PacketManager_lengthInteger__var,
	...
	private CompositeState buildMessageSerializer_SerializerBehavior() {
		...
		final AtomicState state_MessageSerializer_SerializerBehavior_Serialize = new AtomicState(
				"Serialize") {
			@Override
			public void onEntry() {
		...
		states_MessageSerializer_SerializerBehavior
				.add(state_MessageSerializer_SerializerBehavior_Serialize);
		...
		transitions_MessageSerializer_SerializerBehavior
				.add(new InternalTransition("Handler_512351816",
						changeDisplayType, RemoteControl_port,
						state_MessageSerializer_SerializerBehavior_Serialize) {
					@Override
					public void doExecute(final Event e) {
						...
						{
							System.out
									.println("Serializing changeDisplay message");
		...
		final CompositeState state_MessageSerializer_SerializerBehavior = new CompositeState(
				"SerializerBehavior",
				states_MessageSerializer_SerializerBehavior,
				state_MessageSerializer_SerializerBehavior_Serialize,
				transitions_MessageSerializer_SerializerBehavior,
				regions_MessageSerializer_SerializerBehavior, false) {
			@Override
			public void onEntry() {
				{
