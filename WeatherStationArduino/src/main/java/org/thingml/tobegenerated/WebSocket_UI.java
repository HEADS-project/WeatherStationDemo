 ...
 * @author ffl
 */
public class WebSocket_UI extends WebSocketServer implements IWeatherStation_guiClient {
    ...
    public void onMessage(WebSocket ws, String string) {
        ...
        if (message[0].trim().equals("changeDisplay")) weatherstation.changeDisplay_via_gui();
    ...
    public void temperature_from_gui(short RemoteMonitoringMsgs_temperature_temp__var) {
        sendToAll("temperature: " + RemoteMonitoringMsgs_temperature_temp__var);
    }

    @Override
    public void light_from_gui(short RemoteMonitoringMsgs_light_light__var) {
        sendToAll("light: " + RemoteMonitoringMsgs_light_light__var);
    }
}
